...
class ResponseModel {
  ...
  factory ResponseModel.fromMap(Map<String, dynamic> map) {
    return ResponseModel(
      ...
      statistics: List<StatisticsModel>.from(
        (map['statistics'] as List<dynamic>).map<StatisticsModel>(
          (statistic) => StatisticsModel.fromMap(statistic as Map<String, dynamic>),
        ),
      ),
    );
  }
  ...
  @override
  String toString() => 'ResponseModel(player: $player, statistics: $statistics)';
